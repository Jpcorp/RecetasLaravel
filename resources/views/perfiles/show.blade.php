...
@section('content')
    ...
    <h2 class="text-center my-5">Recetas Creadas por: {{ $perfil->perfilToUser->name }}</h2>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ route('recetas.show', ['receta' => $receta->id ]) }}"
                                    class="btn btn-primary d-block mt-4 text-uppercase font-weigth-bold">Ver receta</a>
